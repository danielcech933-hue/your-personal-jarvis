...
export const Route = createFileRoute("/")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Živý hlasový AI společník s autonomní 3D postavou." },
  ] }),
